...
this.set_uniform(this.point_program, "resolution", gl.uniform2f, 0, [canvas.width, canvas.height]);
this.set_uniform(this.point_program, "borderWidth", gl.uniform1f, 0, 10);
